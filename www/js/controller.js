...
function ($scope, NewsService, $cordovaSocialSharing, $ionicSideMenuDelegate) {
    ...
    $scope.relatedStyle = function (index) {
        console.log(index);
        if (index.$index % 2 === 0) {
            return "Title-Three"
        } else {
    ...
    $scope.share = function (Article) {
        $cordovaSocialSharing.share(Article.Title, null, null, Article.LinkUrl);
    };
    $scope.model = NewsService;
 ...
 * Home Page Controller
 */
function ($scope, NewsService, $cordovaSocialSharing, $ionicSideMenuDelegate, $sce) {
    var query = window.location.search;
    // Skip the leading ?, which should always be there,
    // but be careful anyway
    if (query.substring(0, 1) === '?') {
    ...
    NewsService.loadVideo(query).then(function success(data) {
        //  $scope.sendData_RelatedArticles($scope.model.Article.ArticleId, $scope.model.Article.SectionId, 4);
        $scope.model.VideoDetail.YoutubeLink = $sce.trustAsResourceUrl($scope.model.VideoDetail.YoutubeLink);
    }, function error(data) {
        console.log("Error!");
    });
 ...
 * Side navigation Menu Controller
 */
function ($scope, NewsService, $timeout, $ionicSideMenuDelegate) {
    var query = window.location.search;
    // Skip the leading ?, which should always be there,
    // but be careful anyway
    if (query.substring(0, 1) === '?') {
    ...
    if (query === 'Frequent') {
        $scope.model.Title = 'الأكثر قراءة';
...
con.controller("PrimaryVideoController", function ($scope, $ionicLoading, NewsService, $ionicSideMenuDelegate, $ionicSlideBoxDelegate, $sce, $state) {
    ...
    NewsService.loadPublishMainVideoInChannel(1).then(function success(data) {
        $scope.model.NewsMain = NewsService.PublishMainVideoInChannel;
    }, function error(data) {
        console.log("Error!");
    });
    NewsService.loadPublishVideosByChannelId(1, 4).then(function success(data) {
        $scope.model.NewsArticles = NewsService.PublishVideosByChannelId;
    }, function error(data) {
        console.log("Error!");
    });
    ...
    NewsService.loadPublishMainVideoInChannel(2).then(function success(data) {
        $scope.model.UAEMain = NewsService.PublishMainVideoInChannel;
    }, function error(data) {
        console.log("Error!");
    });
    NewsService.loadPublishVideosByChannelId(2, 4).then(function success(data) {
        $scope.model.UAEArticles = NewsService.PublishVideosByChannelId;
    }, function error(data) {
        console.log("Error!");
    });
    ...
    NewsService.loadPublishMainVideoInChannel(3).then(function success(data) {
        $scope.model.DocumentaryMain = NewsService.PublishMainVideoInChannel;
    }, function error(data) {
        console.log("Error!");
    });
    NewsService.loadPublishVideosByChannelId(3, 4).then(function success(data) {
        $scope.model.DocumentaryArticles = NewsService.PublishVideosByChannelId;
    }, function error(data) {
        console.log("Error!");
    });
    ...
    NewsService.loadPublishMainVideoInChannel(4).then(function success(data) {
        $scope.model.VaritiessMain = NewsService.PublishMainVideoInChannel;
    }, function error(data) {
        console.log("Error!");
    });
    NewsService.loadPublishVideosByChannelId(4, 4).then(function success(data) {
        $scope.model.VaritiesArticles = NewsService.PublishVideosByChannelId;
    }, function error(data) {
        console.log("Error!");
    });
    ...
    NewsService.loadPublishMainVideoInChannel(7).then(function success(data) {
        $scope.model.SportMain = NewsService.PublishMainVideoInChannel;
    }, function error(data) {
        console.log("Error!");
    });
    NewsService.loadPublishVideosByChannelId(7, 4).then(function success(data) {
        $scope.model.SportArticles = NewsService.PublishVideosByChannelId;
    }, function error(data) {
        console.log("Error!");
    });
...
con.controller("LatestVideosController", /**
 * Home Page Controller
 */
function ($scope, NewsService) {

    $scope.model = NewsService;
    NewsService.GetLatestVideos(0, 10);
...
con.controller("GetPublishprogramsController", /**
 * Home Page Controller
 */
function ($scope, NewsService) {

    $scope.model = NewsService;
    NewsService.GetPublishprograms();
    ...
    $scope.sendData = function (index) {
        ...
        if (typeof index === 'undefined') {
            ...
            window.location = "Program-category.html?" + index + '&';
            console.log(index);
        }
    };
...
con.controller("GetVideosByProgramIdController", /**
 * Home Page Controller
 */
function ($scope, NewsService,$ionicSideMenuDelegate) {
    var q2;
...
//                console.log(query);
    ...
    if (q2[1] === 'Group') {
        ...
        NewsService.GetVideosByVideoCategoryId(0, 10, q2[0]).then(function success(data) {
            $scope.model.Videos = NewsService.VideosByVideoCategoryId;
        }, function error(data) {
            console.log("Error!");
        });
        ...
        NewsService.GetVideosByProgramId(0, 10, q2[0]).then(function success(data) {
            $scope.model.Videos = NewsService.VideosByProgramId;
        }, function error(data) {
            console.log("Error!");
        });
...
con.controller("GetPublishVideoCategoryController", /**
 * Home Page Controller
 */
function ($scope, NewsService) {

    $scope.model = NewsService;
    NewsService.GetPublishVideoCategory();

    $scope.sendData = function (index, name) {
        // Initialize packed or we get the word 'undefined'
        if (typeof index === 'undefined') {

        } else {
            window.location = "Program-category.html?" + index + "&" + name;
            console.log(index);
        }
    };
