...
serv.service("NewsService", function ($http, $q, $ionicPopup) {
    var self = {
        ...
        'Publishprograms': [],
        'VideosByProgramId':[],
        'PublishVideoCategory':[],
        'VideosByVideoCategoryId':[],
        ...
        'loadRecentArticles': function () {
            var d = $q.defer();
            $http.get("http://24.ae/_MobService/CLS_MobServices.aspx?function=GetScrollArticles&username=24AEMobAdmin&password=24AeMobP@ssword&NumberOfItems=15")
        ...
        'loadVideos': function (ArticleNo) {
            var d = $q.defer();
            $http.get('http://video.24.ae/_MobService/CLS_MobServices.aspx?function=Get24Videos&NumberOfItems='+ArticleNo+'&username=24AEMobAdmin&password=24AeMobP@ssword')
                    .success(function success(data) {
...
//                        old = old.split('/mobile').join('http://24.ae/mobile');
        ...
        'loadPublishVideosByChannelId': function (ChannelId,NumberOfItems) {
         ...
         'GetLatestVideos': function (PageIndex,PageSize) {
            var d = $q.defer();
            $http.get('http://video.24.ae/_MobService/CLS_MobServices.aspx?function=GetLatestVideosWithagging&PageIndex='+ PageIndex + '&PageSize='+ PageSize + '&username=24AEMobAdmin&password=24AeMobP@ssword')
                    .success(function success(data) {
                        var old = JSON.stringify(data).split('~').join('http://video.24.ae');
                       // old = old.split('/mobile').join('http://24.ae/mobile');
                        var NewArray = JSON.parse(old);
                        self.LatestVideos = NewArray;
                        console.log(self.LatestVideos);
                        d.resolve();
                    })
                    .error(function error(msg) {
                        console.log(msg);
        ...
        'GetVideosByProgramId': function (PageIndex,PageSize,ProgramId) {
            var d = $q.defer();
            $http.get('http://video.24.ae/_MobService/CLS_MobServices.aspx?function=GetVideosbyProgramIdWithPagging&PageIndex='+ PageIndex + '&PageSize='+ PageSize + '&ProgramId='+ ProgramId + '&username=24AEMobAdmin&password=24AeMobP@ssword')
                    .success(function success(data) {
                        var old = JSON.stringify(data).split('~').join('http://video.24.ae');
                       // old = old.split('/mobile').join('http://24.ae/mobile');
                        var NewArray = JSON.parse(old);
                        self.VideosByProgramId = NewArray;
                        console.log(self.VideosByProgramId);
                        d.resolve();
                    })
                    .error(function error(msg) {
                        console.log(msg);
         ...
         'GetPublishprograms': function () {
            var d = $q.defer();
            $http.get('http://video.24.ae/_MobService/CLS_MobServices.aspx?function=GetPublishprograms&username=24AEMobAdmin&password=24AeMobP@ssword')
                    .success(function success(data) {
                        var old = JSON.stringify(data).split('~').join('http://video.24.ae');
                       // old = old.split('/mobile').join('http://24.ae/mobile');
                        var NewArray = JSON.parse(old);
                        self.Publishprograms = NewArray;
                        console.log(self.Publishprograms);
                        d.resolve();
                    })
                    .error(function error(msg) {
                        console.log(msg);
        ...
        'GetVideosByVideoCategoryId': function (PageIndex,PageSize,VideoCategoryId) {
            var d = $q.defer();
            $http.get('http://video.24.ae/_MobService/CLS_MobServices.aspx?function=GetVideosbyPlayListIdWithPagging&PageIndex='+ PageIndex + '&PageSize='+ PageSize + '&VideoGroupId='+ VideoCategoryId + '&username=24AEMobAdmin&password=24AeMobP@ssword')
                    .success(function success(data) {
                        var old = JSON.stringify(data).split('~').join('http://video.24.ae');
                       // old = old.split('/mobile').join('http://24.ae/mobile');
                        var NewArray = JSON.parse(old);
                        self.VideosByVideoCategoryId = NewArray;
                        console.log(self.VideosByVideoCategoryId);
                        d.resolve();
                    })
                    .error(function error(msg) {
                        console.log(msg);
         ...
         'GetPublishVideoCategory': function () {
            var d = $q.defer();
            $http.get('http://video.24.ae/_MobService/CLS_MobServices.aspx?function=GetPublishVideoGroup&username=24AEMobAdmin&password=24AeMobP@ssword')
                    .success(function success(data) {
                        var old = JSON.stringify(data).split('~').join('http://video.24.ae');
                       // old = old.split('/mobile').join('http://24.ae/mobile');
                        var NewArray = JSON.parse(old);
                        self.PublishVideoCategory = NewArray;
                        console.log(self.PublishVideoCategory);
                        d.resolve();
                    })
                    .error(function error(msg) {
                        console.log(msg);
